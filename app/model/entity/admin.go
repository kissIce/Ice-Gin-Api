...
type Admin struct {
	...
	RoleId        uint64 `json:"role_id" form:"role_id" gorm:"type:bigint(20);default:0;comment:角色id"`
	//RoleInfo      Role   `json:"role_info" gorm:"foreignKey:id;references:role_id;comment:角色"`
