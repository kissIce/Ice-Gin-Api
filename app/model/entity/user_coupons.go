...
type UserCoupons struct {
  ...
  CouponType int64 `json:"coupon_type" form:"coupon_type"`
  ...
  CouponStartTime int64 `json:"coupon_start_time" form:"coupon_start_time"`
  CouponEndTime int64 `json:"coupon_end_time" form:"coupon_end_time"`
